...
###############################################################################
# /etc/fstab
echo "" && echo "# CIS Benchmark Adjustments" >> /etc/fstab
# CIS 1.1.6
...
# CIS 5.2.12
echo "" && echo "# CIS 5.2.12" >> /etc/audit/audit.rules
...
# CIS 5.2.18
echo "" && echo "# CIS 5.2.18" && "-e 2" >> /etc/audit/audit.rules
...
# CIS 3.1
echo "# CIS Benchmarks" && echo "umask 027" >> /etc/sysconfig/init
...
# CIS 6.2.11
echo "" && echo "# CIS Benchmarks" && echo "# CIS 6.2.12" >> /etc/ssh/sshd_config
...
echo "" && echo "# CIS 6.2.14" >> /etc/ssh/sshd_config
